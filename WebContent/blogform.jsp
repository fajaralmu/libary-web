...
$(document).ready(function(){
	...
	$.ajax({
				...
				success : function(responseText) {
					if(responseText == "oke"){
						$(".blogform").html("<br><h1 align='center' class='oke'>Post berhasil <a href='catatan'>Lihat</a></h1>");
...
<body onload="initDoc();">
	...
	<div class="container">
		...
		<table><tr><td width="300px">
			<div class="blogform">
			<h2 align="center">Posting Baru</h2>
				<form method="post" name="compForm" id="myform">
					<table>
						<tr>
							<td>Judul<br> <input type="text" id="judul" /></td>
						</tr>
						<tr>
							<td>Konten<br>
								...
								<div id="toolBar2">
									...
									<img class="intLink" title="Undo" onclick="formatDoc('undo');"
										...
										title="Insert Image Link" onclick="Confirm.render()"
								...
								<div id="textBox" name="tulisan" contenteditable="true"></div>
								<p id="editMode">
						...
						<tr>
							<td>
							Kategori<select id="kategori" style="width: 100px">
							<option value="1" selected="selected">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
							<option value="4">4</option>
							</select>
							</td><td><input  type="button" id="tombolform" value=" post " /></td>
						</tr>
						<tr><td>Katakunci <input type="text" id="katakunci" /></td></tr>
					</table>
