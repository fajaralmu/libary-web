...
function formSubmit() {
 ...
 var post1 = oDoc.innerHTML;
 var post = post1.replace(/\&/g,"hurufdan");
 alert(post);
 		_("submit").style.display = "none";
		_("status").innerHTML = '<img src="/img/loader.gif">';
		var ajax = ajaxObj("POST", "java.php");
        ajax.send("post_body="+post);
}
